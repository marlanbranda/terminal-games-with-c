///
///
/// this version does clean the terminal after each move. 
/// this version does not fall to infinite loop when char is given as input. BUT IT DOESN'T CLEAR THE TERMINAL THEN.
///
...
int main()
{
    ...
    do
    {
        ...
        int check_if_int = scanf("%d", &selected_col); 
